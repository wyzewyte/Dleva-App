  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col md:pl-64 transition-all duration-300 min-w-0">
        ...
        {/* --- MOBILE HEADER --- */}
        <header className="md:hidden h-16 bg-white border-b border-gray-200 flex items-center justify-between px-3 sticky top-0 z-30 shadow-sm">
        ...
        {isMobileMenuOpen && (
          <div className="fixed inset-0 z-50 md:hidden">
            ...
            ></div>
            {/* Drawer Panel */}
            <div className="absolute left-0 top-0 bottom-0 w-64 max-w-[80vw] bg-white shadow-xl animate-in slide-in-from-left duration-300 overflow-y-auto">
        ...
        {/* --- PAGE CONTENT --- */}
        <main className="flex-1 p-2 sm:p-4 md:p-8 overflow-y-auto min-w-0">
          <Outlet />
        </main>
      </div>
    </div>
